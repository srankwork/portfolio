  ...
  return (
    <div className="detail-card p-[30px] border-l-4 border-[#E5CCFF]">
      <p className="text-[#D1B9E3] text-[14px] font-medium leading-normal">
        An experienced software developer with 4+ years of experience in
        designing and developing high-quality software applications for various
        clients. Proficient in full-stack development, software architecture,
        and database design, with a strong focus on delivering projects on time
        and exceeding expectations. Passionate about learning new technologies
        and staying up-to-date with industry trends. Seeking a challenging role
        in a dynamic organization where I can leverage my skills to drive
        ...
        will be working with—because I’m a programmer.”
      </p>
    </div>
  );
};
          ...
          <div className="mt-[16px] text-[#9B7CBB]">
            ...
            <ul className="pl-[12px] mt-[6px] list-disc">
              {e.details.map((d) => (
                <li
                  key={d}
                  className="list-disc text-[14px] font-medium leading-[163%]"
                >
                  {d}
                </li>
              ))}
      ...
      {pageData.project.map((e) => (
        ...
        >
          <div className="flex items-center">
            ...
            {e.redirectUrl !== "" && (
              <a href={e.redirectUrl} target="_blank">
                <svg
          ...
          <img src={e.image} className="h-[150px] pt-[16px]" alt={e.name} />
        ...
        <div className="flex justify-between">
          ...
          <div className="pr-[40px] flex ">
            ...
            <div className="bg-[#3C156D] rounded-bl-lg rounded-br-lg h-fit">
              <div className="pt-[50px]">
                <a href="https://www.linkedin.com/in/mukesh-rajpurohit-39147016b/" target="_blank">
                  <img
                    className="w-[35px] h-[35px]  rounded-full"
